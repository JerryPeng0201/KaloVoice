...
function process_request(req, res, next){
  ...
  if(req.body.queryResult){ //Recieved the serching request from Google Home
    //req.body.request.intent.name
    if(req.body.queryResult.intent.displayName == "KaloClothes"){ //The intent category is correct
